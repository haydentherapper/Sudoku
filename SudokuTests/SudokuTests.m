...
- (void)testExample
{
    ...
    XCTAssertTrue([_gridModel setValue:1 atRow:6 atCol:2], @"Setting 1 at r7:c3, valid move");
    XCTAssertEqual([_gridModel setValue:1 atRow:6 atCol:2], NO, @"Checking if we can't replace a value");
    XCTAssertTrue([_gridModel getValueAtRow:6 atCol:2] == 1, @"Checking value at r7:c3");
    
    XCTAssertEqual([_gridModel setValue:4 atRow:6 atCol:0], NO, @"Checking logic within 3x3");
    XCTAssertEqual([_gridModel setValue:1 atRow:6 atCol:0], NO, @"Checking logic within row");
    XCTAssertEqual([_gridModel setValue:7 atRow:6 atCol:0], NO, @"Checking logic within col");
}
